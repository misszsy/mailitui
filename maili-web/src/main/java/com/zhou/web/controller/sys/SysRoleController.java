...
public class SysRoleController extends BaseController<SysRoleService, SysRole> {
    ...
    */
    ...
    public @ResponseBody R listData(SysRole sysRole, Integer pageNum, Integer pageSize) {
    ...
    public @ResponseBody R getRoleList() {
    ...
    public @ResponseBody R save(SysRole role) {
        beanValidator(role);
    ...
    public @ResponseBody R update(SysRole role) {
        beanValidator(role);
