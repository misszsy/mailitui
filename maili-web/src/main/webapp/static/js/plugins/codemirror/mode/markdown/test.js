...
(function () {
    ...
    FT("formatting_linkEmail",
        "[link&formatting&formatting-link <][link auth@example.com][link&formatting&formatting-link >]");
    ...
    MT("linkEmail",
        "[link <auth@example.com>] foo");

    MT("linkEmailDouble",
        "[link <auth@example.com>] foo [link <auth@example.com>]");
